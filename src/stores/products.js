...
export const useProductsStore = defineStore('Products', {
  state: () => ({
    ...
    products: [
      ...
      },
      {
        ...
        bestSeller: false,
        bag:0,
        description: "With these mid-top AJ1s, you don't have to choose a favorite color. Contrasting panels make these sneaks stand out, proving that every side is your good side. Durable leather up top and Air cushioning underfoot make 'em perfect for all-day wear—so lace up, and let the compliments roll in."
      },
      {
        id: 8,
        picture: 'y',
  ...
  actions: {
    ...
    addToBag(targetId, selectedsize) {
      ...
      if (!product) {
        return; // Target product not found in products list
      }
    ...
    updateSummary() {
      ...
      this.bag.forEach(item => {
        console.log(item.bag * item.price)
